...
This directory intentionally contains no fabricated screenshots. Capture real
evidence after starting the relevant local or GitHub/AWS view and use these
filenames:
...
Crop out account identifiers, repository secrets, tokens, database URLs, and
any personal information. Add only screenshots that are genuine and current.
