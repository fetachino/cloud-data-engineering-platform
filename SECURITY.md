...
- GitHub Actions uses short-lived OIDC credentials with a `main`-branch trust
  condition instead of long-lived AWS keys.
...
The public ALB currently uses HTTP because no domain or certificate is
